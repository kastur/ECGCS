...
class QRSDet2 {
 public:
  QRSDet2() {
    rsetCount = 0;
    sbcount = QRSParamsWindow<sample_ms, 1500>::samples;
    for (int i = 0; i < 8; i++) {
 ...
 private:
  ...
  QRSFilter<sample_ms> qrs_filter;
  PeakDetector<sample_ms> peak_detector;
  DerivFilter<QRSParams<sample_ms>::d_samples> first_derivative_filter;
  BLSCheckBuffer<sample_ms> bls_check_buffer;
  static const size_t ms_preblank_ = QRSParamsWindow<sample_ms, 200>::samples;
  static const size_t ms_360_ = QRSParamsWindow<sample_ms, 360>::samples;
  static const size_t ms_1000_ = QRSParamsWindow<sample_ms, 1000>::samples;
  static const size_t ms_1650_ = QRSParamsWindow<sample_ms, 1650>::samples;
  static const size_t ms_window_length_ = QRSParams<sample_ms>::mwa_samples;
  static const size_t ms_filter_delay_ = QRSParams<sample_ms>::filter_delay_samples;
